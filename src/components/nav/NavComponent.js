                ...
                <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    ...
                    <div>
                        <Link 
                            ...
                            offset={50} 
                            duration={500} 
                            className="block mt-4 lg:inline-block lg:mt-0 mr-8 cursor-pointer">Home</Link>
                        <Link 
                            activeClass="active" 
                            to="contactus" 
                            spy={true} 
                            ...
                            offset={50} 
                            duration={500} 
                            className="block mt-4 lg:inline-block lg:mt-0 mr-8 cursor-pointer">Kontak Kami</Link>
                        <button className="bg-green-500 hover:bg-green-700 text-white py-2 px-5 rounded">Coba Gratis</button>
